<?php namespace App\Http\Controllers\Admin\Design;
...
class Theme extends Controller {
	...
	public function path() {
		...
		if (substr(str_replace('\\', '/', realpath(DIR_TEMPLATE_FRONTEND . 'default/' . $path)), 0, strlen(DIR_CATALOG . 'view')) == DIR_CATALOG . 'view') {
			$path_data = array();
	...
	public function template() {
		...
		if ($theme_info) {
		    ...
		    $file = view_file($path,$theme,'catalog');
	...
	public function reset() {
		...
		if (is_file(DIR_TEMPLATE_FRONTEND . $theme . '/' . $path) && (substr(str_replace('\\', '/', realpath(DIR_TEMPLATE_FRONTEND . $theme . '/' . $path)), 0, strlen(DIR_CATALOG . 'view')) == DIR_CATALOG . 'view')) {
			$json['code'] = file_get_contents(DIR_TEMPLATE_FRONTEND . $theme . '/' . $path);
		}
