...
namespace App\System\Library\TwigBridge;
...
class ServiceProvider extends ViewServiceProvider
{
    ...
    {
        if (!$this->isRunningOnPhp7() and !class_exists('App\System\Library\TwigBridge\Extension\Laravel\Str')) {
            class_alias('App\System\Library\TwigBridge\Extension\Laravel\Str', 'TwigBridge\Extension\Laravel\Str');
        }
    }
