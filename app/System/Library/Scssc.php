...
class Scssc {
	...
	public function compile($code, $name = null)
	{
		...
		$_class = 'App\System\Library\\'.$this->formatter;
		$this->formatter = new $_class();
...
class scss_parser {
	...
	protected function makeOperatorStr($operators) {
		return '('.implode('|', array_map(array($this,'preg_quote'), $operators)).')';
	}
